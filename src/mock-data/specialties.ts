...
export const mockSpecialties: Specialty[] = [
  {
    ...
    longDescription: "Khoa Nội khoa Bệnh Viện Vạn Hạnh cung cấp dịch vụ chẩn đoán và điều trị toàn diện các bệnh lý nội khoa bao gồm bệnh tiêu hoá, hô hấp, nội tiết, cơ xương khớp và thần kinh. Đội ngũ bác sĩ giàu kinh nghiệm, trang thiết bị hiện đại.",
    doctorCount: 8,
    isActive: true,
  ...
  },
  {
    ...
    longDescription: "Khoa Ngoại khoa Bệnh Viện Vạn Hạnh với trang thiết bị phẫu thuật hiện đại, phòng mổ đạt tiêu chuẩn quốc tế. Chuyên phẫu thuật nội soi ít xâm lấn.",
    doctorCount: 7,
    isActive: true,
    createdAt: "2023-01-01T00:00:00Z",
